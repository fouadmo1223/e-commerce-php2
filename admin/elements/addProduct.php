...
<body>
    ...
    <h4 class="my-3 hvr-float-shadow">Add Product Page</h4>

    <form class="add-product w-100" enctype="multipart/form-data" data-aos="zoom-in">
        <div class="row">

        <div class="form-group col-12 col-lg-6">
            <label for="productName" class=" fw-bold">Product Name</label>
            <input type="text" name="productName" required  placeholder="Enter product name"  class="form-control" id="productName" aria-describedby="emailHelp">
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <input type="number" required name="productPrice" placeholder="Enter product price"  class="form-control" id="productPrice" aria-describedby="emailHelp">
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <input type="number" required name="productCount" placeholder="Enter product quantity"  class="form-control" id="productCount" aria-describedby="emailHelp">
        ...
        <div class="form-group col-12 col-lg-6">
            ...
            <input type="number" required name="productSale" placeholder="Enter product sale"  class="form-control" id="productSale" aria-describedby="emailHelp">
        ...
        <div class="form-group col-12 " style="padding-left:15px">
            ...
            <textarea class="form-control product-describtion" required  name="productDescribtion" placeholder="Enter product describtion" id="productDescribtion" rows="4"></textarea>
        ...
        <div class="form-group col-12 col-lg-6">
            <label for="productBrand">Product Main category</label>
            <select class="form-control" required name="productMainCat" id="productBrand">
                <?php
                    $selectMianCat = $connection -> query("SELECT * FROM main_cats");
                    foreach( $selectMianCat as $mainCat ){
                ?>
                <option <?php
                if($mainCat['id'] == 1){
                    echo "selected";
            ...
            <div class="product-main-cat-validation">  
            </div>
        </div>

        <div class="col-12 p-15">
            <div class="custom-file ">
                    <input type="file" required  name="productImage" accept="image/*" class="custom-file-input" id="customFile">
                    <label class="custom-file-label" for="customFile">Choose Product image</label>
            </div>
            <div class="product-image-validation">  
            </div>
                <img src="" class="uploadedImage d-none" style="width: 70px; height:70px; margin-top:10px" alt="">
        </div>

        <div class="col-12 p-15">
            <div class="form-group">
                <div class="form-check">
                    <input class="form-check-input" name="new" type="checkbox" value="1" id="New" >
        ...
        $("#customFile").change(function (e) {
            ...
            if (selectedFile) {
                ...
                reader.onload = function (e) {
                    ...
                    $(`.uploadedImage`).attr("src", imageDataUrl).removeClass("d-none");
                };
